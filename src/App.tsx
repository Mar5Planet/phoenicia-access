      ...
      <Content style={{ padding: '2rem', maxWidth: 1050, margin: '0 auto' }}>
        ...
        <div data-aos="fade-up">
          <Section
            ...
            paragraphs={[
              "With over 40 years of experience in real estate development and architectural engineering, Eng. Hassan Mustafa brings deep, practical expertise to every project...",
              "As Phoenicia Access Group’s local advisor, he provides direct access to vetted land, reliable contractors...",
            ]}
            imageSrc="/hassan.jpg"
